...
func NewServer(options *ServerOptions) (*Server, error) {
	...
	router.Path("/cases").Methods(http.MethodGet).HandlerFunc(h.Cases)
	router.Path("/cases/new").Methods(http.MethodGet).HandlerFunc(h.NewCase)
	router.Path("/cases/{id}").Methods(http.MethodGet).HandlerFunc(h.Case)
