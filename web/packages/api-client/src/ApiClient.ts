...
export type RecordCreateRequest = PartialObjectWrapper<RecordInstance>
export type RecordCreateResponse = Response<RecordCreateRequest, RecordInstance>
...
export type RecordGetResponse = Response<RecordGetRequest, RecordInstance>
...
export class ApiClient implements ClientIntf {
...
export const defaultClient: ClientIntf = new ApiClient()
