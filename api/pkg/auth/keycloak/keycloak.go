...
func (c *KeycloakClient) GetToken(realmName string) (string, error) {

	reqUrl := fmt.Sprintf("%s/auth/realms/%s/protocol/openid-connect/token", c.baseUrl.String(), realmName)
...
func (c *KeycloakClient) CreateUser(token string, realmName string, user *User) (*User, error) {

	reqUrl := fmt.Sprintf("%s/auth/admin/realms/%s/users", c.baseUrl.String(), realmName)
	...
	return c.GetUser(token, realmName, userID)

}

func (c *KeycloakClient) DeleteUser(token string, realmName string, id string) error {

	reqUrl := fmt.Sprintf("%s/auth/admin/realms/%s/users/%s", c.baseUrl.String(), realmName, id)
...
func (c *KeycloakClient) GetUser(token, realmName, id string) (*User, error) {
...
func (c *KeycloakClient) GetUserByUsername(token, realmName, username string) (*User, error) {
	users, err := c.ListUsers(token, realmName, ListUserOptions{
		Username: username,
	})
...
func (c *KeycloakClient) UpdateUser(token, realmName string, user *User) (*User, error) {

	reqUrl := fmt.Sprintf("%s/auth/admin/realms/%s/users/%s", c.baseUrl.String(), realmName, user.ID)
	...
	return c.GetUser(token, realmName, user.ID)
...
func (c *KeycloakClient) ListUsers(token string, realmName string, options ListUserOptions) ([]*User, error) {
	...
	reqURL := fmt.Sprintf("%s/auth/admin/realms/%s/users?%s", c.baseUrl.String(), realmName, qryParams.Encode())
...
func (c *KeycloakClient) CreateClientScope(token, realmName string, scope *ClientScope) (*ClientScope, error) {

	reqUrl := fmt.Sprintf("%s/auth/admin/realms/%s/client-scopes", c.baseUrl.String(), realmName)
	...
	return c.GetClientScope(token, realmName, clientScopeID)

}

func (c *KeycloakClient) ListClientScopes(token, realmName string) ([]*ClientScope, error) {

	baseUrl := *c.baseUrl
	reqUrl := fmt.Sprintf("%s/auth/admin/realms/%s/client-scopes", baseUrl.String(), realmName)
...
func (c *KeycloakClient) GetClientScope(token, realmName, id string) (*ClientScope, error) {

	reqUrl := fmt.Sprintf("%s/auth/admin/realms/%s/client-scopes/%s", c.baseUrl.String(), realmName, id)
	req, err := http.NewRequest("GET", reqUrl, nil)
	if err != nil {
		return nil, err
	}
...
func (c *KeycloakClient) UpdateClientScope(token, realmName string, clientScope *ClientScope) (*ClientScope, error) {

	reqUrl := fmt.Sprintf("%s/auth/admin/realms/%s/client-scopes/%s",
		c.baseUrl.String(), realmName, clientScope.ID)
	...
	return c.GetClientScope(token, realmName, clientScope.ID)

}

func (c *KeycloakClient) CreateProtocolMapper(token, realmName, clientScopeID string, protocolMapper *ProtocolMapper) (*ProtocolMapper, error) {

	reqUrl := fmt.Sprintf("%s/auth/admin/realms/%s/client-scopes/%s/protocol-mappers/models", c.baseUrl.String(), realmName, clientScopeID)
	...
	return c.GetProtocolMapper(token, realmName, clientScopeID, protocolMapperID)

}

func (c *KeycloakClient) GetProtocolMapper(token, realmName, clientScopeID, id string) (*ProtocolMapper, error) {

	reqUrl := fmt.Sprintf("%s/auth/admin/realms/%s/client-scopes/%s/protocol-mappers/models/%s", c.baseUrl.String(), realmName, clientScopeID, id)
...
func (c *KeycloakClient) UpdateProtocolMapper(token, realmName string, clientScopeID string, protocolMapper *ProtocolMapper) (*ProtocolMapper, error) {

	reqUrl := fmt.Sprintf("%s/auth/admin/realms/%s/client-scopes/%s/protocol-mappers/models/%s", c.baseUrl.String(), realmName, clientScopeID, protocolMapper.ID)
	...
	return c.GetProtocolMapper(token, realmName, clientScopeID, protocolMapper.ID)

}

func (c *KeycloakClient) DeleteProtocolMapper(token, realmName string, clientScopeID, ID string) error {
