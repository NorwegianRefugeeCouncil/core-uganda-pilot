...
func autoConvert_v1_AdditionalBeneficiaryInformation_To_core_AdditionalBeneficiaryInformation(in *AdditionalBeneficiaryInformation, out *core.ClaimSpecification, s conversion.Scope) error {
	out.Key = in.Key
	out.Type = in.Type
	return nil
}
...
func Convert_v1_AdditionalBeneficiaryInformation_To_core_AdditionalBeneficiaryInformation(in *AdditionalBeneficiaryInformation, out *core.ClaimSpecification, s conversion.Scope) error {
	return autoConvert_v1_AdditionalBeneficiaryInformation_To_core_AdditionalBeneficiaryInformation(in, out, s)
}

func autoConvert_core_AdditionalBeneficiaryInformation_To_v1_AdditionalBeneficiaryInformation(in *core.ClaimSpecification, out *AdditionalBeneficiaryInformation, s conversion.Scope) error {
	out.Key = in.Key
	out.Type = in.Type
	return nil
}
...
func Convert_core_AdditionalBeneficiaryInformation_To_v1_AdditionalBeneficiaryInformation(in *core.ClaimSpecification, out *AdditionalBeneficiaryInformation, s conversion.Scope) error {
...
func autoConvert_v1_OperatingScope_To_core_OperatingScope(in *OrganizationScope, out *core.OperatingScope, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
...
func Convert_v1_OperatingScope_To_core_OperatingScope(in *OrganizationScope, out *core.OperatingScope, s conversion.Scope) error {
	return autoConvert_v1_OperatingScope_To_core_OperatingScope(in, out, s)
}

func autoConvert_core_OperatingScope_To_v1_OperatingScope(in *core.OperatingScope, out *OrganizationScope, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
...
func Convert_core_OperatingScope_To_v1_OperatingScope(in *core.OperatingScope, out *OrganizationScope, s conversion.Scope) error {
...
func autoConvert_core_OperatingScopeList_To_v1_OperatingScopeList(in *core.OperatingScopeList, out *OperatingScopeList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]OrganizationScope)(unsafe.Pointer(&in.Items))
	return nil
}
...
func autoConvert_v1_OperatingScopeSpec_To_core_OperatingScopeSpec(in *OrganizationScopeSpec, out *core.OperatingScopeSpec, s conversion.Scope) error {
	out.AdditionalUserInformation = *(*[]core.ClaimSpecification)(unsafe.Pointer(&in.AdditionalBeneficiaryInformation))
	return nil
}

// Convert_v1_OperatingScopeSpec_To_core_OperatingScopeSpec is an autogenerated conversion function.
func Convert_v1_OperatingScopeSpec_To_core_OperatingScopeSpec(in *OrganizationScopeSpec, out *core.OperatingScopeSpec, s conversion.Scope) error {
	return autoConvert_v1_OperatingScopeSpec_To_core_OperatingScopeSpec(in, out, s)
}

func autoConvert_core_OperatingScopeSpec_To_v1_OperatingScopeSpec(in *core.OperatingScopeSpec, out *OrganizationScopeSpec, s conversion.Scope) error {
	out.AdditionalBeneficiaryInformation = *(*[]AdditionalBeneficiaryInformation)(unsafe.Pointer(&in.AdditionalUserInformation))
	return nil
}

// Convert_core_OperatingScopeSpec_To_v1_OperatingScopeSpec is an autogenerated conversion function.
func Convert_core_OperatingScopeSpec_To_v1_OperatingScopeSpec(in *core.OperatingScopeSpec, out *OrganizationScopeSpec, s conversion.Scope) error {
