...
func ValidateCustomResourceDefinition(obj *core.CustomResourceDefinition, requestGV schema.GroupVersion) field.ErrorList {
...
func ValidateCustomResourceDefinitionUpdate(obj, oldObj *core.CustomResourceDefinition, requestGV schema.GroupVersion) field.ErrorList {
	...
	opts := validationOptions{
		...
		//requireImmutableNames:                    core.IsCRDConditionTrue(oldObj, core.Established),
...
func ValidateCustomResourceDefinitionStoredVersions(storedVersions []string, versions []core.CustomResourceDefinitionVersion, fldPath *field.Path) field.ErrorList {
...
func ValidateUpdateCustomResourceDefinitionStatus(obj, oldObj *core.CustomResourceDefinition) field.ErrorList {
	allErrs := genericvalidation.ValidateObjectMetaUpdate(&obj.ObjectMeta, &oldObj.ObjectMeta, field.NewPath("metadata"))
	//allErrs = append(allErrs, ValidateCustomResourceDefinitionStatus(&obj.Status, field.NewPath("status"))...)
	return allErrs
}
...
func validateCustomResourceDefinitionVersion(version *core.CustomResourceDefinitionVersion, fldPath *field.Path, opts validationOptions) field.ErrorList {
	allErrs := field.ErrorList{}
	...
	//}
	allErrs = append(allErrs, validateCustomResourceDefinitionValidation(&version.Schema, opts, fldPath.Child("schema"))...)
...
func validateCustomResourceDefinitionSpec(spec *core.CustomResourceDefinitionSpec, opts validationOptions, fldPath *field.Path) field.ErrorList {
	allErrs := field.ErrorList{}
	...
	// allErrs = append(allErrs, validateEnumStrings(fldPath.Child("scope"), string(spec.Scope), []string{string(core.ClusterScoped), string(core.NamespaceScoped)}, true)...)
	...
	for i, version := range spec.Versions {
		...
		allErrs = append(allErrs, validateCustomResourceDefinitionVersion(&version, fldPath.Child("versions").Index(i), opts)...)
	}
	...
	//}
	//
	//if (spec.Conversion != nil && spec.Conversion.Strategy != core.NoneConverter) && (spec.PreserveUnknownFields == nil || *spec.PreserveUnknownFields) {
...
var acceptedConversionReviewVersions = sets.NewString(corev1.SchemeGroupVersion.Version)
...
//func ValidateCustomResourceConversion(conversion *core.CustomResourceConversion, fldPath *field.Path) field.ErrorList {
//	return validateCustomResourceConversion(conversion, true, fldPath)
//}
//
//func validateCustomResourceConversion(conversion *core.CustomResourceConversion, requireRecognizedVersion bool, fldPath *field.Path) field.ErrorList {
//	allErrs := field.ErrorList{}
//	if conversion == nil {
//		return allErrs
//	}
//	allErrs = append(allErrs, validateEnumStrings(fldPath.Child("strategy"), string(conversion.Strategy), []string{string(core.NoneConverter), string(core.WebhookConverter)}, true)...)
//	if conversion.Strategy == core.WebhookConverter {
...
func validateCustomResourceDefinitionSpecUpdate(spec, oldSpec *core.CustomResourceDefinitionSpec, opts validationOptions, fldPath *field.Path) field.ErrorList {
...
//func getSubresourcesForVersion(crd *core.CustomResourceDefinitionSpec, version string) *core.CustomResourceSubresources {
...
//func hasAnyStatusEnabled(crd *core.CustomResourceDefinitionSpec) bool {
...
//func hasStatusEnabled(subresources *core.CustomResourceSubresources) bool {
...
//func hasPerVersionSchema(versions []core.CustomResourceDefinitionVersion) bool {
//	for _, v := range versions {
//		if v.Schema != nil {
//			return true
//		}
...
//func hasPerVersionSubresources(versions []core.CustomResourceDefinitionVersion) bool {
//	for _, v := range versions {
...
//func hasPerVersionColumns(versions []core.CustomResourceDefinitionVersion) bool {
//	for _, v := range versions {
...
func hasIdenticalPerVersionSchema(versions []core.CustomResourceDefinitionVersion) bool {
	...
	for _, v := range versions {
		if !apiequality.Semantic.DeepEqual(v.Schema, value) {
			return false
		}
	}
	return true
...
func hasIdenticalPerVersionSubresources(versions []core.CustomResourceDefinitionVersion) bool {
	if len(versions) == 0 {
		return false
	}
...
//func hasIdenticalPerVersionColumns(versions []core.CustomResourceDefinitionVersion) bool {
//	if len(versions) == 0 {
//		return false
//	}
...
//func ValidateCustomResourceDefinitionStatus(status *core.CustomResourceDefinitionStatus, fldPath *field.Path) field.ErrorList {
//	allErrs := field.ErrorList{}
...
func ValidateCustomResourceDefinitionNames(names *core.CustomResourceDefinitionNames, fldPath *field.Path) field.ErrorList {
	allErrs := field.ErrorList{}
...
//func ValidateCustomResourceColumnDefinition(col *core.CustomResourceColumnDefinition, fldPath *field.Path) field.ErrorList {
//	allErrs := field.ErrorList{}
//
//	if len(col.Name) == 0 {
...
type specStandardValidator interface {
	validate(spec *core.JSONSchemaProps, fldPath *field.Path) field.ErrorList
...
func validateCustomResourceDefinitionValidation(customResourceValidation *core.CustomResourceDefinitionValidation, opts validationOptions, fldPath *field.Path) field.ErrorList {
	allErrs := field.ErrorList{}
	...
	if schema := customResourceValidation.OpenAPIV3Schema; true {
		...
		if opts.requireStructuralSchema {
			...
			} else if validationErrors, err := defaulting.ValidateDefaults(fldPath.Child("openAPIV3Schema"), ss, true, opts.requirePrunedDefaults); err != nil {
...
func ValidateCustomResourceDefinitionOpenAPISchema(schema *core.JSONSchemaProps, fldPath *field.Path, ssv specStandardValidator, isRoot bool, opts *validationOptions) field.ErrorList {
	allErrs := field.ErrorList{}
...
func validateMapListKeysMapSet(schema *core.JSONSchemaProps, fldPath *field.Path) field.ErrorList {
	allErrs := field.ErrorList{}
...
func (v *specStandardValidatorV3) validate(schema *core.JSONSchemaProps, fldPath *field.Path) field.ErrorList {
	allErrs := field.ErrorList{}
...
//func ValidateCustomResourceDefinitionSubresources(subresources *core.CustomResourceSubresources, fldPath *field.Path) field.ErrorList {
//	allErrs := field.ErrorList{}
//
//	if subresources == nil {
//		return allErrs
...
func requireOpenAPISchema(requestGV schema.GroupVersion, oldCRDSpec *core.CustomResourceDefinitionSpec) bool {
...
func allVersionsSpecifyOpenAPISchema(spec *core.CustomResourceDefinitionSpec) bool {
	//if spec.Validation != nil && spec.Validation.OpenAPIV3Schema != nil {
	//	return true
	//}
...
func allowDefaults(requestGV schema.GroupVersion, oldCRDSpec *core.CustomResourceDefinitionSpec) (bool, string) {
...
func specHasDefaults(spec *core.CustomResourceDefinitionSpec) bool {
	return hasSchemaWith(spec, schemaHasDefaults)
}

func schemaHasDefaults(s *core.JSONSchemaProps) bool {
	return schemaHas(s, func(s *core.JSONSchemaProps) bool {
		return s.Default != nil
	})
}

func hasSchemaWith(spec *core.CustomResourceDefinitionSpec, pred func(s *core.JSONSchemaProps) bool) bool {
	//if spec.Validation != nil && spec.Validation.OpenAPIV3Schema != nil && pred(spec.Validation.OpenAPIV3Schema) {
	//	return true
	//}
	for _, v := range spec.Versions {
		if pred(&v.Schema.OpenAPIV3Schema) {
			return true
		}
	}
	return false
...
func schemaHas(s *core.JSONSchemaProps, pred func(s *core.JSONSchemaProps) bool) bool {
	if s == nil {
		return false
	}
...
func specHasKubernetesExtensions(spec *core.CustomResourceDefinitionSpec) bool {
	//if spec.Validation != nil && schemaHasKubernetesExtensions(spec.Validation.OpenAPIV3Schema) {
	//	return true
	//}
	for _, v := range spec.Versions {
		if schemaHasKubernetesExtensions(&v.Schema.OpenAPIV3Schema) {
			return true
		}
	}
	return false
...
func schemaHasKubernetesExtensions(s *core.JSONSchemaProps) bool {
	return schemaHas(s, func(s *core.JSONSchemaProps) bool {
...
func requireStructuralSchema(requestGV schema.GroupVersion, oldCRDSpec *core.CustomResourceDefinitionSpec) bool {
...
func specHasNonStructuralSchema(spec *core.CustomResourceDefinitionSpec) bool {
	for _, v := range spec.Versions {
		if schemaIsNonStructural(&v.Schema.OpenAPIV3Schema) {
			return true
		}
	}
	return false
}
func schemaIsNonStructural(schema *core.JSONSchemaProps) bool {
	if schema == nil {
		return false
	}
...
func requirePrunedDefaults(oldCRDSpec *core.CustomResourceDefinitionSpec) bool {
...
func schemaHasUnprunedDefaults(schema *core.JSONSchemaProps) (bool, error) {
	...
	pruned := ss.DeepCopy()
	if err := defaulting.PruneDefaults(pruned); err != nil {
		return false, err
	}
...
func requireAtomicSetType(oldCRDSpec *core.CustomResourceDefinitionSpec) bool {
...
func hasNonAtomicSetType(schema *core.JSONSchemaProps) bool {
	return schemaHas(schema, func(schema *core.JSONSchemaProps) bool {
...
func requireMapListKeysMapSetValidation(oldCRDSpec *core.CustomResourceDefinitionSpec) bool {
	return !hasSchemaWith(oldCRDSpec, hasInvalidMapListKeysMapSet)
}

func hasInvalidMapListKeysMapSet(schema *core.JSONSchemaProps) bool {
	return schemaHas(schema, func(schema *core.JSONSchemaProps) bool {
...
func requireValidPropertyType(requestGV schema.GroupVersion, oldCRDSpec *core.CustomResourceDefinitionSpec) bool {
...
func validateAPIApproval(newCRD, oldCRD *core.CustomResourceDefinition, requestGV schema.GroupVersion) field.ErrorList {
	...
	newApprovalState, _ := apihelpers.GetAPIApprovalState(newCRD.Annotations)
	...
	//	return field.ErrorList{field.Invalid(field.NewPath("metadata", "annotations").Key(corev1beta1.KubeAPIApprovedAnnotation), newCRD.Annotations[corev1beta1.KubeAPIApprovedAnnotation], reason)}
	//case apihelpers.APIApprovalMissing:
	//	return field.ErrorList{field.Required(field.NewPath("metadata", "annotations").Key(corev1beta1.KubeAPIApprovedAnnotation), reason)}
...
func validatePreserveUnknownFields(crd, oldCRD *core.CustomResourceDefinition, requestGV schema.GroupVersion) field.ErrorList {
...
func specHasInvalidTypes(spec *core.CustomResourceDefinitionSpec) bool {
	for _, v := range spec.Versions {
		if SchemaHasInvalidTypes(&v.Schema.OpenAPIV3Schema) {
			return true
		}
	}
	return false
...
func SchemaHasInvalidTypes(s *core.JSONSchemaProps) bool {
	return schemaHas(s, func(s *core.JSONSchemaProps) bool {
