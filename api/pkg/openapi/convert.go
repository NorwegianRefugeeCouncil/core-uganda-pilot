...
// - externalDocs
// - example.
func NewStructural(s *core.JSONSchemaProps) (*Structural, error) {
	if s == nil {
		return nil, nil
	}
...
func newGenerics(s *core.JSONSchemaProps) (*Generic, error) {
	if s == nil {
		return nil, nil
	}
	g := &Generic{
	...
	if s.Default != nil {
		var i interface{}
		if err := json.Unmarshal(s.Default.Raw, &i); err != nil {
			return nil, err
		}
		g.Default = JSON{i}
	}
...
func newValueValidation(s *core.JSONSchemaProps) (*ValueValidation, error) {
	if s == nil {
		return nil, nil
	}
...
func newNestedValueValidation(s *core.JSONSchemaProps) (*NestedValueValidation, error) {
	if s == nil {
		return nil, nil
	}
...
func newExtensions(s *core.JSONSchemaProps) (*Extensions, error) {
	if s == nil {
		return nil, nil
	}
...
func validateUnsupportedFields(s *core.JSONSchemaProps) error {
	if len(s.ID) > 0 {
