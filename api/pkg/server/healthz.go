...
func (s *APIServer) AddHealthChecks(checks ...healthz.HealthChecker) error {
...
func (s *APIServer) AddBootSequenceHealthChecks(checks ...healthz.HealthChecker) error {
...
func (s *APIServer) addHealthChecks(livezGracePeriod time.Duration, checks ...healthz.HealthChecker) error {
	s.healthzLock.Lock()
...
func (s *APIServer) AddReadyzChecks(checks ...healthz.HealthChecker) error {
	s.readyzLock.Lock()
...
func (s *APIServer) AddLivezChecks(delay time.Duration, checks ...healthz.HealthChecker) error {
	s.livezLock.Lock()
...
// shutdown.
func (s *APIServer) addReadyzShutdownCheck(stopCh <-chan struct{}) error {
...
func (s *APIServer) installReadyz() {
	s.readyzLock.Lock()
	defer s.readyzLock.Unlock()
