...
type FormDefinitionInterface interface {
	Create(ctx context.Context, FormDefinition *corev1.FormDefinition, opts metav1.CreateOptions) (*corev1.FormDefinition, error)
	Update(ctx context.Context, FormDefinition *corev1.FormDefinition, opts metav1.UpdateOptions) (*corev1.FormDefinition, error)
	Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error
	Get(ctx context.Context, name string, opts metav1.GetOptions) (*corev1.FormDefinition, error)
	List(ctx context.Context, opts metav1.ListOptions) (*corev1.FormDefinitionList, error)
...
func (c *formDefinitions) Get(ctx context.Context, name string, options metav1.GetOptions) (result *corev1.FormDefinition, err error) {
	result = &corev1.FormDefinition{}
	err = c.client.Get().
...
func (c *formDefinitions) List(ctx context.Context, opts metav1.ListOptions) (result *corev1.FormDefinitionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &corev1.FormDefinitionList{}
	err = c.client.Get().
		Resource("formdefinitions").
...
func (c *formDefinitions) Create(ctx context.Context, formDefinition *corev1.FormDefinition, opts metav1.CreateOptions) (result *corev1.FormDefinition, err error) {
	result = &corev1.FormDefinition{}
	err = c.client.Post().
		Resource("formdefinitions").
		VersionedParams(&opts, scheme2.ParameterCodec).
...
func (c *formDefinitions) Update(ctx context.Context, formDefinition *corev1.FormDefinition, opts metav1.UpdateOptions) (result *corev1.FormDefinition, err error) {
	result = &corev1.FormDefinition{}
	err = c.client.Put().
		Resource("formdefinitions").
