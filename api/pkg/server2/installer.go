...
func (i *APIInstaller) registerResourceHandlers(path string, storage rest.Storage, ws *restful.WebService) error {
...
func restfulGetResource(r rest.Getter, scope handlers.RequestScope) restful.RouteFunction {
	return func(request *restful.Request, response *restful.Response) {
		handlers.GetResource(&scope, r)(response.ResponseWriter, request.Request)
	}
}
func restfulCreateResource(r rest.Creater, scope handlers.RequestScope) restful.RouteFunction {
	return func(request *restful.Request, response *restful.Response) {
		handlers.CreateResource(&scope, r)(response.ResponseWriter, request.Request)
	}
}
func restfulDeleteResource(r rest.Deleter, scope handlers.RequestScope) restful.RouteFunction {
	return func(request *restful.Request, response *restful.Response) {
		handlers.DeleteResource(&scope, r)(response.ResponseWriter, request.Request)
	}
}
func restfulUpdateResource(r rest.Updater, scope handlers.RequestScope) restful.RouteFunction {
	return func(request *restful.Request, response *restful.Response) {
		handlers.UpdateResource(&scope, r)(response.ResponseWriter, request.Request)
	}
}
func restfulListResource(r rest.Lister, scope handlers.RequestScope) restful.RouteFunction {
	return func(request *restful.Request, response *restful.Response) {
		handlers.ListResource(&scope, r)(response.ResponseWriter, request.Request)
	}
}
