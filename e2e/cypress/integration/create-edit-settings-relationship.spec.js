        ...
        describe("Create", () => {
            it("registers a new relationship type", () => {
                ...
                cy.get('@testFirstPartyTypeOption')
                    .invoke('prop', 'value')
                    .then(value => {
                        cy.get('select[name="rules[0].firstPartyTypeId"]').select(value)
                    })
            ...
            it("saved the relationship type", () => {
                ...
                cy.get('a[data-cy=relationshiptype]').last().click({force: true})
                // redirected to relationshiptype view page

                cy.get('input[name=name]').should('have.value', mockText)
                cy.get('input[name=isDirectional]').invoke('prop', 'checked').then(checked => expect(checked).to.be.false)
                cy.get('input[name=firstPartyRole]').should('have.value', mockText)
                cy.get('@testFirstPartyTypeOption')
                    .invoke('prop', 'value')
                    .then(value => {
                        cy.get('select[name="rules[0].firstPartyTypeId"]').should('have.value', value)
                    })
            })
        })
        describe("Update", () => {
            it("updates the relationship type", () => {
                ...
                cy.get('input[name=firstPartyRole]').clear().type(mockUpdatedText)
            ...
            it("saved the updated relationship type", () => {
                ...
                cy.get('input[name=isDirectional]').invoke('prop', 'checked').then(checked => expect(checked).to.be.false)
                cy.get('input[name=firstPartyRole]').should('have.value', mockUpdatedText)
                cy.get('@testFirstPartyTypeOption2')
                    .invoke('prop', 'value')
                    .then(value => {
                        cy.get('select[name="rules[0].firstPartyTypeId"]').should('have.value', value)
        ...
        describe("Create", () => {
            it("registers a new relationship type", () => {
                ...
                cy.get('@testSecondPartyTypeOption')
                    .invoke('prop', 'value')
                    .then(value => {
                        cy.get('select[name="rules[0].secondPartyTypeId"]').select(value)
                    })
            ...
            it("saved the relationship type", () => {
                ...
                cy.get('input[name=name]').should('have.value', mockText)
                cy.get('input[name=isDirectional]').invoke('prop', 'checked').then(checked => expect(checked).to.be.true)
                cy.get('input[name=firstPartyRole]').should('have.value', mockText)
                cy.get('input[name=secondPartyRole]').should('have.value', mockText)
                cy.get('@testFirstPartyTypeOption')
                    .invoke('prop', 'value')
                    .then(value => {
                        cy.get('select[name="rules[0].firstPartyTypeId"]').should('have.value', value)
                ...
                cy.get('@testSecondPartyTypeOption')
                    .invoke('prop', 'value')
                    .then(value => {
                        cy.get('select[name="rules[0].secondPartyTypeId"]').should('have.value', value)
                    })
            })
        })
        describe("Update", () => {
            it("updates the relationship type", () => {
                ...
                cy.get('input[name=name]').clear().type(mockUpdatedText)
                cy.get('input[name=firstPartyRole]').clear().type(mockUpdatedText)
                cy.get('input[name=secondPartyRole]').clear().type(mockUpdatedText)
                cy.get('@testFirstPartyTypeOption2')
                    .invoke('prop', 'value')
                    .then(value => {
                        cy.get('select[name="rules[0].firstPartyTypeId"]').select(value)
            ...
            it("saved the updated relationship type", () => {
                ...
                cy.get('input[name=isDirectional]').invoke('prop', 'checked').then(checked => expect(checked).to.be.true)
                cy.get('input[name=firstPartyRole]').should('have.value', mockUpdatedText)
                cy.get('input[name=secondPartyRole]').should('have.value', mockUpdatedText)
                cy.get('@testFirstPartyTypeOption2')
                    .invoke('prop', 'value')
                    .then(value => {
                        cy.get('select[name="rules[0].firstPartyTypeId"]').should('have.value', value)
