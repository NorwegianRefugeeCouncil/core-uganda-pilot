...
const NavigationBar: React.FC<NavigationProps> = ({ navigation, back, options }) => {
  ...
  return (
    <Appbar.Header>
      ...
      <NavigationDropdown visible={visible} closeMenu={closeMenu} openMenu={openMenu} navigation={navigation} />
    </Appbar.Header>
  );
};
