...
jest.mock('../../src/utils/storage', () => {
  return {
    ...
    storeEncryptedLocalData: (recordId: any, key: any, data: any) => mockStoreEncryptedLocalData(recordId, key, data),
  };
});
...
describe(AddRecordScreenContainer.name, () => {
  ...
  test('stores local data on user submit when offline', async () => {
    ...
    expect(mockStoreEncryptedLocalData).toHaveBeenCalledWith(mockRoute.params.recordId, mockEncryptionKey, mockLocalData);
