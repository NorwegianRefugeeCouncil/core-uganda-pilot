...
func (h *Handler) AuthClients(w http.ResponseWriter, req *http.Request) {
...
func (h *Handler) AuthClientNewSecret(w http.ResponseWriter, req *http.Request) {
	ctx := req.Context()
...
func (h *Handler) AuthClient(w http.ResponseWriter, req *http.Request) {
...
func (h *Handler) DeleteAuthClient(w http.ResponseWriter, req *http.Request) {
...
func (h *Handler) PostAuthClient(w http.ResponseWriter, req *http.Request, isNew bool, cli *models.OAuth2Client) {
