...
var (
	...
	HowellMembership = mbship("", Howell, teams.KampalaResponseTeam)
	...
	BirdieMembership = mbship("", Birdie, teams.KampalaResponseTeam)
	...
	CharisMembership = mbship("", Charis, teams.KampalaResponseTeam)
	...
	DanyialMembership = mbship("", Danyial, teams.KampalaResponseTeam)
	...
	DeviMembership = mbship("", Devi, teams.KampalaICLATeam)
	...
	LevanMembership = mbship("", Levan, teams.KampalaICLATeam)
	...
	LiadanMembership = mbship("", Liadan, teams.NairobiResponseTeam)
	...
	MuhammadMembership = mbship("", Muhammad, teams.NairobiResponseTeam)
	...
	SimeonMembership = mbship("", Simeon, teams.NairobiICLATeam)
	...
	SayenMembership = mbship("", Sayen, teams.NairobiICLATeam)
...
func staf(id string, individual parties.Party) *staff.Staff {
	s := &staff.Staff{
		ID:             id,
		OrganizationID: organizations.NRC.ID,
...
var mbships []*memberships.Membership

func mbship(id string, individual parties.Party, team teams.Team) *memberships.Membership {
