...
func NewRESTClient(baseURL *url.URL, versionedAPIPath string, config RESTClientConfig, httpClient *http.Client) *RESTClient {
...
func NewRequest(c *RESTClient) *Request {
	...
	switch {
	case len(c.config.AcceptContentType) > 0:
		r.SetHeader("Accept", c.config.AcceptContentType)
...
func NewRequestWithClient(base *url.URL, versionedAPIPath string, config RESTClientConfig, client *http.Client) *Request {
