...
import (
	...
	"github.com/nrc-no/core/apps/api/pkgs2/runtime/serializer/json"
)
...
func (u *UnstructuredList) MarshalJSON() ([]byte, error) {
	...
	err := json.UnstructuredJSONScheme.Encode(u, &buf)
...
func (u *UnstructuredList) UnmarshalJSON(b []byte) error {
	_, _, err := json.UnstructuredJSONScheme.Decode(b, nil, u)
	return err
}
