...
import (
  ...
  "github.com/nrc-no/core/apps/api/pkg/apis/apiextensions/validation"
  metav1 "github.com/nrc-no/core/apps/api/pkg/apis/meta/v1"
  openapi "github.com/nrc-no/core/apps/api/pkg/endpoints/openapi"
  "github.com/nrc-no/core/apps/api/pkg/runtime"
  openapiv2 "github.com/nrc-no/core/apps/api/pkg/server/extensions-apiserver/controller/openapi/v2"
  "github.com/nrc-no/core/apps/api/pkg/server/extensions-apiserver/helpers"
  structuralschema "github.com/nrc-no/core/apps/api/pkg/server/extensions-apiserver/schema"
  openapi2 "k8s.io/apiextensions-apiserver/pkg/generated/openapi"
...
func BuildSwagger(crd *apiextensionsv1.CustomResourceDefinition, version string, opts Options) (*spec.Swagger, error) {
  ...
  s, err := helpers.GetSchemaForVersion(crd, version)
  if err != nil {
    return nil, err
  }
  ...
  subresources, err := helpers.GetSubresourcesForVersion(crd, version)
  if err != nil {
    return nil, err
  }
...
func (b *builder) buildRoute(root, path, httpMethod, actionVerb, operationVerb string, sample interface{}) *restful.RouteBuilder {
  ...
  if httpMethod == "PATCH" {
    supportedTypes := []string{
      string(patch.JSONPatchType),
      string(patch.MergePatchType),
    }
    if utilfeature.DefaultFeatureGate.Enabled(features.ServerSideApply) {
      supportedTypes = append(supportedTypes, string(patch.ApplyPatchType))
    }
...
func (b *builder) getOpenAPIConfig() *common.Config {
  return &common.Config{
    ...
    GetDefinitions: func(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
      def := openapi2.GetOpenAPIDefinitions(ref)
